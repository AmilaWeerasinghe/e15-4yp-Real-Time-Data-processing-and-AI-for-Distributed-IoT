...
tic = time.process_time()
# divide the num of channels among nodes
out = y.conv_forward(image, w.W1[:, :, :, a:(2*a)],
                     w.b1[:, :, :, a:(2*a)], w.hparameters1)
toc = time.process_time()
print("Computation time conv part3 = " + str(1000*(toc - tic)) + "ms")
tic = time.process_time()
c.join()
